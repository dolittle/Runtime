...
## Microservice
A _microservice_ consist of one or many heads talking to one or many runtimes. The core idea is that a microservice is an independently scalable unit of deployment that can be reused in other parts of the software however you like.

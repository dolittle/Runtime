...
##### Artifacts
A *Bounded Context* will eventually consist of a set of [*Artifacts*](/overview/artifacts/), they are what actually defines the behaviour and functionality of the *Bounded Context*. The *Artifacts* will be [*Events*](/overview/events/domain_events/), [Commands](/overview/command/introduction/), [Event Sources](/overview/events/event_sourcing/), [Queries](/overview/read/query/) and [Read Models](/overview/read/read_model/). You should read about the different types of *Artifacts* to gain an understanding of how they'll impact the *Application* / *Bounded Context*.

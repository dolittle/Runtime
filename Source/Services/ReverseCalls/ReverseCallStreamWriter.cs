    ...
    where TResponse : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReverseCallStreamWriter{TClientMessage,TServerMessage,TConnectArguments,TConnectResponse,TRequest,TResponse}"/> class.
    /// </summary>

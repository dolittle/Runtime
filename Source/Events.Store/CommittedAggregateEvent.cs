...
namespace Dolittle.Runtime.Events.Store
{
    ...
    public class CommittedAggregateEvent : CommittedEvent
    {
        ...
        public CommittedAggregateEvent(EventSourceId eventSource, Artifact aggregateRoot, AggregateRootVersion aggregateRootVersion, EventLogVersion eventLogVersion, DateTimeOffset occured, CorrelationId correlationId, Microservice microservice, TenantId tenant, Cause cause, Artifact type, string content)
            : base(eventLogVersion, occured, correlationId, microservice, tenant, cause, type, content)
        {

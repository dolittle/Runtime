...
namespace Dolittle.Runtime.Events.Store.Streams
{
    ...
    /// </summary>
    public class NoEventInPartitionInStreamFromPosition : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoEventInPartitionInStreamFromPosition" /> class.
        /// </summary>
        ...
        public NoEventInPartitionInStreamFromPosition(StreamId stream, ScopeId scope, PartitionId partition, StreamPosition position)

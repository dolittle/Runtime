...
$PROTOC -I./ -I../../Protobuf/ --js_out=import_style=commonjs,binary:./CommonJs/Protobuf  ../../Protobuf/dolittle/interaction/events.relativity/*.proto ../../Protobuf/system/*.proto --grpc_out ./Commonjs/Grpc --plugin=protoc-gen-grpc=$PLUGIN

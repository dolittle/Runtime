...
namespace Dolittle.Runtime.CLI.Runtime.EventHandlers
{
    ...
    public interface IManagementClient
    {
        ...
        /// </summary>
        /// <param name="scope">The scope of the Event Handler.</param>
        ...
        Task ReprocessEventsFrom(ScopeId scope, EventProcessorId eventHandler, TenantId tenant, StreamPosition position, MicroserviceAddress runtime);
        ...
        /// <param name="runtime">The address of the Runtime to connect to.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        Task ReprocessAllEvents(ScopeId scope, EventProcessorId eventHandler, MicroserviceAddress runtime);
    }
}
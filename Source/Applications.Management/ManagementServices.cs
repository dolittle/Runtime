...
namespace Dolittle.Runtime.Applications.Management
{
    /// <summary>
    ...
    public class ManagementServices : ICanBindManagementServices
    {
        ...
        {
            return new Service[] {
                new Service(_clientsService, Dolittle.Applications.Management.Clients.BindService(_clientsService), Dolittle.Applications.Management.Clients.Descriptor)
            };
        }
    }
}
...
public interface IValidateFilterForAllTenants
{
    ...
    Task<IDictionary<TenantId, FilterValidationResult>> Validate<TDefinition>(Func<IServiceProvider, IFilterProcessor<TDefinition>> getFilterProcessor, CancellationToken cancellationToken)

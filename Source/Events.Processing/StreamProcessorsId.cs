...
namespace Dolittle.Runtime.Events.Processing
{
    ...
    /// </summary>
    public class StreamProcessorsId : Value<StreamProcessorId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamProcessorsId"/> class.
        /// </summary>
        /// <param name="eventProcessorId"><see cref="EventProcessorId"/>.</param>
        /// <param name="sourceStreamId">The <see cref="StreamId"/>.</param>
        public StreamProcessorsId(EventProcessorId eventProcessorId, StreamId sourceStreamId)
        {

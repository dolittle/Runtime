...
$PROTOC -I./ -I../../Protobuf/ --csharp_out ./Relativity/Protobuf ../../Protobuf/dolittle/interaction/events.relativity/*.proto ../../Protobuf/system/*.proto --grpc_out ./Relativity/Grpc --plugin=protoc-gen-grpc=$PLUGIN

...
{
    /// <summary>
    /// Represents the binder that gives us the <see cref="Runtime.Grpc.Interaction.Grpc.QuantumTunnelService"/>
    /// </summary>
    /// <remarks>
    ...
    public class GravitationalLens : ICanBindInteractionServices
    {
        ...
        public IEnumerable<ServerServiceDefinition> BindServices()
        {
            ...
            return new ServerServiceDefinition[] {
                Runtime.Grpc.Interaction.Grpc.QuantumTunnelService.BindService(service)
            };
        }
    }
}
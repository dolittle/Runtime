...
//
//     /// <inheritdoc/>
//     public Task WaitForEvent(ScopeId scope, StreamId stream, ProcessingPosition position, CancellationToken token)
//         => WaitForEventAtPositionWithTimeout(scope, stream, position, TimeSpan.FromMinutes(1), false, token);
//
//     /// <inheritdoc/>
//     public Task WaitForEvent(ScopeId scope, StreamId stream, ProcessingPosition position, TimeSpan timeout, CancellationToken token)
...
//
//     /// <inheritdoc/>
//     public Task WaitForEvent(StreamId stream, ProcessingPosition position, CancellationToken token)
//         => WaitForEventAtPositionWithTimeout(ScopeId.Default, stream, position, TimeSpan.FromMinutes(1), true, token);
//
//     /// <inheritdoc/>
//     public Task WaitForEvent(StreamId stream, ProcessingPosition position, TimeSpan timeout, CancellationToken token)
...
//
//     Task WaitForEventAtPositionWithTimeout(ScopeId scope, StreamId stream, ProcessingPosition position, TimeSpan timeout, bool isPublic, CancellationToken token)
//         => WaitForWithTimeout(
//             scope,
//             stream,
//             timeout,
...
//     }
//
//     void NotifyForEvent(ScopeId scope, StreamId stream, ProcessingPosition position, bool isPublic)
//     {
...
//     }
//
//     public void NotifyForEvent(ScopeId scope, StreamId stream, StreamPosition position) => throw new NotImplementedException();
// }

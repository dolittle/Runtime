...
public class EventHorizonEventsWriter : IWriteEventHorizonEvents
{
    ...
    /// <inheritdoc/>
    public async Task<StreamPosition> Write(CommittedEvent @event, ConsentId consentId, ScopeId scope, CancellationToken cancellationToken)
    {

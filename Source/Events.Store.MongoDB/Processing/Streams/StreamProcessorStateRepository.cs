...
namespace Dolittle.Runtime.Events.Store.MongoDB.Processing.Streams
{
    ...
    public class StreamProcessorStateRepository : IStreamProcessorStateRepository
    {
        ...
        {
            _logger.LogTrace("Trying to get Stream Processor State for {StreamProcessorId}", id);
            try
            {
        ...
        {
            _logger.LogTrace("Persisting Stream Processor State for {StreamProcessorId}", id);
            try
            {
                if (id is SubscriptionId subscriptionId)
                {

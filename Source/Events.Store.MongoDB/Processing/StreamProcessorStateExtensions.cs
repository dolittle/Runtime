...
namespace Dolittle.Runtime.Events.Store.MongoDB.Processing
{
    ...
    public static class StreamProcessorStateExtensions
    {
        ...
        public static Runtime.Events.Processing.FailingPartitionState ToRuntimeRepresentation(this FailingPartitionState state) => new Runtime.Events.Processing.FailingPartitionState { Position = state.Position, RetryTime = state.RetryTime, Reason = state.Reason };

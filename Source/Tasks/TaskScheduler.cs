...
namespace Dolittle.Tasks
{
    ...
    public class TaskScheduler : ITaskScheduler
    {
        ...
        readonly Dictionary<Task, Guid[]> _taskOperationIds;
        ...
        void ScheduleOperation(Task task, bool[] operationsDone, int operationIndex, Action<Task> taskDone)
        {
            ...
            _taskOperationIds[task][currentOperationIndex] = _scheduler.Start<Task>(t => t.Operations[currentOperationIndex](t, currentOperationIndex), task, _ =>
            {

...
namespace Dolittle.Runtime.Server.HealthChecks
{
    ...
    public class ProjectionStoreHealthCheck : MongoDatabaseHealthCheck
    {
        ...
        public ProjectionStoreHealthCheck(FactoryFor<TenantsConfiguration> getTenants, IExecutionContextManager executionContextManager, FactoryFor<DatabaseConnection> getConnectionForTenant)

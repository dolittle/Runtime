...
public class objects : given.a_converter_and_inputs
{
    ...
    It should_have_the_correct_first_object = () => result["first_object"].Should().BeEquivalentTo(new BsonDocument(new []
    {
        new BsonElement("some_string", new BsonString("hello world")),
        new BsonElement("some_int", new BsonInt32(42)),
    }));
    It should_have_the_correct_second_object = () => result["second_object"].Should().BeEquivalentTo(new BsonDocument(new []
    {

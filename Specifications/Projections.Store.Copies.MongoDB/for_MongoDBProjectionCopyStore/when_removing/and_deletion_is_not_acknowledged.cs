...
public class and_deletion_is_not_acknowledged : given.a_projection_copy_store_and_a_projection
{
    Establish context = () =>
    {
        collection
            .Setup(_ => _.DeleteOneAsync(Moq.It.IsAny<FilterDefinition<BsonDocument>>(), cancellation_token))

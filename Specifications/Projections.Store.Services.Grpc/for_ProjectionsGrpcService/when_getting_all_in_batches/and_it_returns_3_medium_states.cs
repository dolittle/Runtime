...
public class and_it_returns_3_medium_states : given.the_service_and_get_all_request
{
    private Establish context = () =>
    {
        ...
        {
            new (ProjectionCurrentStateType.Persisted, GenerateRandomString(1000000), "key 01"),
            new (ProjectionCurrentStateType.Persisted, GenerateRandomString(1000000), "key 02"),
            new (ProjectionCurrentStateType.Persisted, GenerateRandomString(1000000), "key 03"),
        };

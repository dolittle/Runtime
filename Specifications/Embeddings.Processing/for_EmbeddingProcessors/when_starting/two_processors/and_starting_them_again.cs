...
public class and_starting_them_again : given.two_tenants_and_processors
{
    ...
    It should_not_be_successful = () => result.Success.Should().BeFalse();
    It should_fail_because_emmbedding_processors_already_registered = () => result.Exception.Should().BeOfType<EmbeddingProcessorsAlreadyRegistered>();

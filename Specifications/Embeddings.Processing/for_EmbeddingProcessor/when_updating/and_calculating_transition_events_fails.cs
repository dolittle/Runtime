...
namespace Dolittle.Runtime.Embeddings.Processing.for_EmbeddingProcessor.when_updating
{
    public class and_everything_works : given.all_dependencies_and_a_desired_state
    {
        ...
        Establish context = () =>
        {
            ...
            transition_calculator.Setup(_ => _.TryConverge(current_state, desired_state, CancellationToken.None)).Returns(Task.FromResult(Try<UncommittedAggregateEvents>.Failed(exception)));
        };

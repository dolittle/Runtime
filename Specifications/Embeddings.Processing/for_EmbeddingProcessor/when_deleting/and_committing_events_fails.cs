...
namespace Dolittle.Runtime.Embeddings.Processing.for_EmbeddingProcessor.when_deleting
{
    public class and_committing_events_fails : given.all_dependencies_and_a_key
    {
        ...
        Establish context = () =>
        {
            ...
            event_store.Setup(_ => _.CommitAggregateEvents(uncommitted_events, Moq.It.IsAny<CancellationToken>())).Returns(Task.FromException<CommittedAggregateEvents>(exception));
        };

...
public class and_one_of_two_keys_fails : given.all_dependencies
{
    ...
    It should_project_the_event_for_a = () => project_many_events.Verify(_ => _.TryProject(current_state_a, unprocessed_events_a, execution_context, cancellation_token));
    ...
    It should_project_the_event_for_b = () => project_many_events.Verify(_ => _.TryProject(current_state_b, unprocessed_events_b, execution_context, cancellation_token));

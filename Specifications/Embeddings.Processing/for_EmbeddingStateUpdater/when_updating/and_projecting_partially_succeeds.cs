...
public class and_projecting_partially_succeeds : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        unprocessed_events = new CommittedAggregateEvents(projection_key.Value, embedding.Value, current_state.Version, new[] { unprocessed_event });
    ...
    It should_not_succeed = () => result.Success.Should().BeFalse();

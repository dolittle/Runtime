...
public class and_desired_state_is_reached_after_second_compare : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        embedding
            .Setup(_ => _.TryDelete(intermediate_current_embedding_state, execution_context, cancellation))
    ...
    It should_delete_with_current_state = () => embedding.Verify(_ => _.TryDelete(current_state, execution_context, cancellation), Moq.Times.Once);
    It should_delete_with_intermediate_state = () => embedding.Verify(_ => _.TryDelete(intermediate_current_embedding_state, execution_context, cancellation), Moq.Times.Once);

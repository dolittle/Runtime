...
namespace Dolittle.Runtime.Events.Processing.for_RemoteFilterProcessor.when_filtering
{
    public class and_filtering_failed : given.all_dependencies
    {
        ...
        Establish context = () => remote_processor = new RemoteFilterProcessor(target_stream_id, Processing.given.a_remote_filter_service(new FailedFilteringResult(reason)), event_to_stream_writer_mock.Object, Moq.Mock.Of<ILogger>());

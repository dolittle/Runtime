...
namespace Dolittle.Runtime.Events.Processing.for_RemoteFilterProcessor.when_filtering
{
    public class and_filtering_failed : given.all_dependencies
    {
        ...
        Establish context = () => remote_processor = new RemoteFilterProcessor(event_processor_id, target_stream_id, Processing.given.a_remote_filter_service(new FailedFilteringResult()), event_to_stream_writer_mock.Object);

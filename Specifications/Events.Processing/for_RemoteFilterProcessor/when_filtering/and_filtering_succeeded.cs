...
namespace Dolittle.Runtime.Events.Processing.for_RemoteFilterProcessor.when_processing
{
    public class and_filtering_succeeded : given.all_dependencies
    {
        ...
        Establish context = () => remote_processor = new RemoteFilterProcessor(event_processor_id, target_stream_id, Processing.given.a_remote_filter_service(new SucceededFilteringResult(is_included, partition)), new in_memory_event_to_stream_writer());

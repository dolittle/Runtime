    ...
    public class and_there_is_a_different_set_of_event_types : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            definition = given.projection_definition_builder
                ...
                .with_selector(new ProjectionEventSelector(new Artifact("fde86d09-1c24-40ae-afc9-d85100cabdd9", 1), ProjectEventKeySelectorType.EventSourceId))
                .build();
            ...
            definitions
                ...
                .Returns(Task.FromResult<Try<ProjectionDefinition>>(definition with
                {
                    Events = new[]
                    {
                        new ProjectionEventSelector(new Artifact("d773ce48-409b-4352-b22b-8794053229a0", 1), ProjectEventKeySelectorType.EventSourceId)
                    }
                }));
        };

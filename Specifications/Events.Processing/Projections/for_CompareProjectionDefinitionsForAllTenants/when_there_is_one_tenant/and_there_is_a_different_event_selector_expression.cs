...
{
    public class and_there_is_a_different_event_selector_expression : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            definition = given.projection_definition_builder
                ...
                .with_selector(new ProjectionEventSelector(event_type, ProjectEventKeySelectorType.Property, "some expression"))
                .build();
            ...
            definitions
                ...
                .Returns(Task.FromResult<Try<ProjectionDefinition>>(definition with
                {
                    Events = new[]
                    {
                        new ProjectionEventSelector(event_type, ProjectEventKeySelectorType.Property, "some other expression")
                    }
                }));
        };

...
public class and_there_is_a_different_event_selector_static_key : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        definition = given.projection_definition_builder
            ...
            .with_selector(ProjectionEventSelector.Static(event_type, "some key"))
        ...
        definitions
            ...
            .Returns(Task.FromResult<Try<ProjectionDefinition>>(definition with
            {
                Events = new[]
                {
                    ProjectionEventSelector.Static(event_type, "some other key")
                }
            }));
    };

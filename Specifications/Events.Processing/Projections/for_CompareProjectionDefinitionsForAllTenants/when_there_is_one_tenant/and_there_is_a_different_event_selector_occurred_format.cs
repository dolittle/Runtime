...
public class and_there_is_a_different_event_selector_occurred_format : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        definition = given.projection_definition_builder
            ...
            .with_selector(ProjectionEventSelector.Occurred(event_type, "HH:mm:dd"))
        ...
        definitions
            ...
            .Returns(Task.FromResult<Try<ProjectionDefinition>>(definition with
            {
                Events = new[]
                {
                    ProjectionEventSelector.Occurred(event_type, "HH:mm")
                }
            }));
    };

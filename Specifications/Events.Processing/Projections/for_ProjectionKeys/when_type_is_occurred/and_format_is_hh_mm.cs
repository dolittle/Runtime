...
public class and_format_is_hh_mm : all_dependencies
{
    ...
    Establish context = () =>
    {
        occurred_format = "hh:mm";
        committed_event = given.an_event.that_occurred_at(DateTimeOffset.Parse("05/01/2020 12:32:31", CultureInfo.InvariantCulture));
        partition = "/(partition!";
    ...
    It should_have_key_be_the_occurred_format = () => key.Value.ShouldEqual("12:32");
}
...
{
    public class of_complex_type : given.all_dependencies
    {
        static bool result;
        ...
        Because of = () => result = extractor.TryExtract(
            ...
            $"{nameof(json_object.inner_structure)}.{json_object.inner_structure.inner_property}",
            out key);

        It should_return_true = () => result.ShouldBeTrue();
        It should_set_key_correct_value = () => key.Value.ShouldEqual("inner_property");
    }
}
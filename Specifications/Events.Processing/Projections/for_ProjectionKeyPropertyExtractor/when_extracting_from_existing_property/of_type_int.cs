...
public class of_type_int : given.all_dependencies
{
    static bool result;
    ...
    Because of = () => result = extractor.TryExtract(serializer.ToJson(json_object), nameof(json_object.a_number_property), out key);

...
namespace Dolittle.Runtime.Events.Processing.for_RemoteEventProcessor.given
{
    ...
    {
        protected const string reason = "some reason";
        ...
        protected static readonly IProcessingResult failed_handling_result = new FailedProcessingResult(reason);
        protected static readonly IProcessingResult retry_handling_result = new RetryProcessingResult(retry_timeout, reason);

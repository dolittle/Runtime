...
public class but_fails_on_last_event : given.all_dependencies
{
    ...
    It should_have_the_correct_position_on_failing_partition = () => failing_partition(first_failing_partition_id).Position.ShouldEqual(new StreamPosition(first_initial_failing_partition_position.StreamPosition + 2));

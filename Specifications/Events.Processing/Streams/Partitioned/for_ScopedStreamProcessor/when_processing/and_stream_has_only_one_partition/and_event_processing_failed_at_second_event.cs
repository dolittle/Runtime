...
public class and_event_processing_failed_at_second_event : given.all_dependencies
{
    ...
    It should_have_current_position_equal_1 = () => current_stream_processor_state.Position.StreamPosition.ShouldEqual(new StreamPosition(2));
    ...
    It should_have_the_correct_position_on_the_failing_partition = () => current_stream_processor_state.FailingPartitions[partition_id].Position.StreamPosition.ShouldEqual(new StreamPosition(1));

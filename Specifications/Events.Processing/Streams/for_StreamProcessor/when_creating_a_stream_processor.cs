...
namespace Dolittle.Runtime.Events.Processing.Streams.for_StreamProcessor
{
    public class when_creating_a_stream_processor : given.all_dependencies
    {
        ...
        Because of = () => stream_processor = new StreamProcessor(tenant_id, source_stream_id, event_processor_mock.Object, stream_processor_states, next_event_fetcher.Object, default, Moq.Mock.Of<ILogger>());

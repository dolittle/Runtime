...
namespace Dolittle.Runtime.Events.Processing.Streams.for_ScopedStreamProcessor.when_processing.stream_with_one_event
{
    public class and_everything_is_ok : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            setup_event_fetcher(event_with_partition);
        };

        Because of = () => start_stream_processor_and_cancel_after(TimeSpan.FromMilliseconds(200)).GetAwaiter().GetResult();
        ...
        // It should_wait_for_next_event = should_be_waiting_for_next_event;

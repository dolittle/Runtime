...
namespace Dolittle.Runtime.Events.Processing.Streams.for_StreamProcessors.given
{
    public class all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            logger_manager.Setup(_ => _.CreateLogger<StreamProcessors>()).Returns(Moq.Mock.Of<ILogger<StreamProcessors>>());
            stream_processors = new StreamProcessors(on_all_tenants.Object, get_stream_processor_state_repository.Object, get_event_fetchers.Object, logger_manager.Object);
        };
    }
}
...
namespace Dolittle.Runtime.Events.Processing.for_Processors.given
{
    public class all_dependencies
    {
        ...
        protected static Mock<FactoryFor<IStreamProcessors>> get_stream_processor_hub_mock;
        protected static Mock<FactoryFor<IWriteEventsToStreams>> get_event_to_stream_writer_mock;
        protected static Mock<IStreamProcessors> stream_processor_hub_mock;

        Establish context = () =>
        {
            tenants_mock = new Mock<ITenants>();
            execution_context_manager_mock = new Mock<IExecutionContextManager>();
            stream_processor_hub_mock = new Mock<IStreamProcessors>();
            get_stream_processor_hub_mock = new Mock<FactoryFor<IStreamProcessors>>();
            get_stream_processor_hub_mock.Setup(_ => _.Invoke()).Returns(stream_processor_hub_mock.Object);
            get_event_to_stream_writer_mock = new Mock<FactoryFor<IWriteEventsToStreams>>();

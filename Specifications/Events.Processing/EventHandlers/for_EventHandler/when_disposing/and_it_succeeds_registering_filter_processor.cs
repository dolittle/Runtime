...
{
    public class and_it_succeeds_registering_filter_processor : given.an_event_handler
    {
        ...
        It should_try_to_register_event_processor = () => stream_processors.Verify(_ => _
                                                                .TryRegister(
                                                                    event_handler.Scope,
                                                                    event_handler.EventProcessor,

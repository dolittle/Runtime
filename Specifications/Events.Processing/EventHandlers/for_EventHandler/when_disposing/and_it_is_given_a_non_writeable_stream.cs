...
public class and_it_is_given_a_non_writeable_stream : given.an_event_handler_with_non_writeable_target_stream
{
    ...
    It should_reject_with_cannot_register_event_handler_on_writeable_stream = () => failure.Id.Should().Be(EventHandlersFailures.CannotRegisterEventHandlerOnNonWriteableStream);

...
public class and_filtered_successfully : given.a_public_event_filter
{
    ...
    Establish context = () =>
    {
        ...
        dispatcher.Setup(_ => _.Call(Moq.It.IsAny<FilterEventRequest>(), Moq.It.IsAny<ExecutionContext>(), Moq.It.IsAny<CancellationToken>())).Returns(Task.FromResult(filter_response));
    };

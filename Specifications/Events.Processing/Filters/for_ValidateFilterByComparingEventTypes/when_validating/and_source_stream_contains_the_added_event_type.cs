...
{
    public class and_source_stream_contains_the_added_event_type : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            types_fetcher
                .Setup(_ => _.FetchInRange(new StreamPositionRange(0, 5), cancellation_token))
        ...
        Because of = () => result = validator.Validate(new_filter_definition, filter_processor, 5, CancellationToken.None).GetAwaiter().GetResult();

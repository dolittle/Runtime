...
{
    public class and_there_are_multiple_migrations_that_can_migrate : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            second_migration.Setup(_ => _.CanMigrateFor(from, to)).Returns(true);
        ...
        It should_fail_because_multiple_migrators_defined = () => result.Exception.ShouldBeOfExactType<MultipleMigratorsDefinedBetweenVersions>();

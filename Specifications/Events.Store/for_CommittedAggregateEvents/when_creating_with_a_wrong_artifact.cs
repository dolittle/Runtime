...
public class when_creating_with_a_wrong_artifact : given.events_and_an_artifact
{
    ...
    Establish context = () => wrong_aggregate_event = new CommittedAggregateEvent(wrong_aggregate_artifact, aggregate_version_after, 3, DateTimeOffset.UtcNow, event_source_id, execution_contexts.create(), event_b_artifact, is_public, "wrong");

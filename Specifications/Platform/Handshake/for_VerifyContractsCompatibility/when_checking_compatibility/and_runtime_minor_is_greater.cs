...
public class and_runtime_minor_is_greater : given.a_verifier_and_versions
{
    Establish context = () =>
    {
        runtime_contracts_version = new Version(20, 31, 80);
        head_contracts_version = new Version(20, 30, 100);
    };

...
{
    public class when_reapplying_events_to_a_wrong_version : given.committed_events_and_two_aggregate_roots
    {
        ...
        Establish context = () =>
        {
            events = build_committed_events(event_source_id, typeof(StatefullAggregateRoot), 1);
        };

...
namespace Dolittle.Events.Specs.for_EventSource.given
{
    public class a_committed_event_builder
    {
        ...
        Establish context = () => a_versioned_event_source = new VersionedEventSource(EventSourceId.New(), ArtifactId.New());
        ...
        {
            return new OriginalContext(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), "specs", new Security.Claims(Array.Empty<Security.Claim>()));
        }
    }
}
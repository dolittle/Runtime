...
{
    public class when_creating_a_new_committed_aggregate_events_with_an_event_applied_by_another_aggregate_root : given.an_aggregate_instance_and_some_committed_events
    {

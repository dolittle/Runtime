...
{
    public class and_consent_is_acknowledged : given.all_dependencies
    {
        static Exception result;

        Establish context = () => grpc_consumer_client.Setup(_ =>
            _.AcknowledgeConsent(Moq.It.IsAny<grpc.AcknowledgeRequest>(), Moq.It.IsAny<Metadata>(), Moq.It.IsAny<DateTime?>(), Moq.It.IsAny<CancellationToken>())).Returns(new grpc.AcknowledgeResponse { Acknowledged = true });
        ...
        It should_not_fail = () => result.ShouldBeNull();
    }
}
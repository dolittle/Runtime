...
{
    public class and_it_subscription_failed_processing : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            subscription
                .Setup(_ => _.Start())
                .Callback(() => subscription.SetupGet(_ => _.State).Returns(SubscriptionState.FailedToProcess));

            subscriptions.Subscribe(subscription_id);
        ...
        It should_not_create_a_new_subscription = () => subscription_factory.Verify(_ => _.Create(
            ...
            Moq.It.IsAny<MicroserviceAddress>()), Moq.Times.Once);

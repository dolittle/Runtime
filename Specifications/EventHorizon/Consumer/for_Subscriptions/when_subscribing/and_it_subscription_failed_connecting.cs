...
{
    public class and_it_subscription_failed_connecting : given.all_dependencies
    {
        ...
        Establish context = () =>
        {
            subscription
                .Setup(_ => _.Start())
                .Callback(() => subscription.SetupGet(_ => _.State).Returns(SubscriptionState.FailedToConnect));

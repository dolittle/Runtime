...
public class when_getting_values : Rudimentary.given.concepts
{
    ...
    It should_be_an_empty_string = () => result_of_empty_string.Should().Be("");
    It should_be_a_default_string = () => result_of_null_string.Should().Be(default(string));
    It should_be_a_default_string_from_value = () => result_of_null_value_string.Should().Be(default(string));
}
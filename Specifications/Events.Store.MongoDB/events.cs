...
namespace Dolittle.Runtime.Events.Store.MongoDB
{
    public static class events
    {
        ...
        public static event_builder an_event_not_from_aggregate_builder(EventLogSequenceNumber event_log_sequence_number) => new(event_log_sequence_number);
        ...
        public static stream_event_builder an_aggregate_stream_event_builder(StreamPosition stream_position, PartitionId partition, AggregateRootVersion aggregate_version) => new(stream_position, partition, aggregate_version);

        public static stream_event_builder a_stream_event_not_from_aggregate_builder(StreamPosition stream_position, PartitionId partition) => new(stream_position, partition);

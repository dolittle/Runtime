...
namespace Dolittle.Runtime.Events.Store.MongoDB
{
    public static class events
    {
        ...
        public static event_builder an_aggregate_event_builder(EventLogSequenceNumber event_log_sequence_number, AggregateRootVersion aggregate_version) => new event_builder(event_log_sequence_number, aggregate_version);

        public static event_builder an_event_not_from_aggregate_builder(EventLogSequenceNumber event_log_sequence_number) => new event_builder(event_log_sequence_number);
        ...
        public static stream_event_builder a_stream_event_not_from_aggregate_builder(StreamPosition stream_position, PartitionId partition) => new stream_event_builder(stream_position, partition);

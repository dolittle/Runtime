...
namespace Dolittle.Runtime.Events.Store.MongoDB.Streams.for_UniqueEventsToWriteGetter.when_getting_unique.stream_events.and_there_are_one_event_to_write_and_one_stored;
...
public class and_they_are_the_same : given.all_dependencies
{
    ...
    It should_have_none_unique_events = () => unique_stream_events.ShouldBeEmpty();
}
...
namespace Dolittle.Runtime.Events.Store.MongoDB.Streams.for_StreamDefinition
{
    public class when_creating
    {
        ...
        Establish context = () =>
        {
            ...
            filter_definition = new FilterDefinition(stream_id, StreamId.EventLog, partitioned);
            partitioned = true;
            @public = false;
        };
        ...
        It should_have_the_correct_filter_definition = () => result.FilterDefinition.ShouldEqual(filter_definition);
    }
}
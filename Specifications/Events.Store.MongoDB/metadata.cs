...
{
    public static event_metadata_builder new_event_metadata => new();

    public static EventMetadata random_event_metadata => new event_metadata_builder().build();

    public static stream_event_metadata_builder new_stream_event_metadata => new();

    public static StreamEventMetadata random_stream_event_metadata => new stream_event_metadata_builder().build();

    public static event_horizon_metadata_builder new_event_horizon_metadata => new();
    ...
    public static AggregateMetadata aggregate_metadata_from_non_aggregate_event => new();
}
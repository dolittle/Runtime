...
public class for_one_aggregate_instance : given.all_dependencies
{
    ...
    Because of = () => updater.UpdateAggregateVersions(session.Object, create_commit(0, (aggregate_root, event_source, expected_version, 1)), cancellation_token).GetAwaiter().GetResult();

...
namespace Dolittle.Runtime.Events.Store.MongoDB.Persistence.for_UpdateAggregateVersionsAfterCommit.when_commit_has.one_commited_aggregate_events;
...
public class for_two_aggregate_instance : given.all_dependencies
{
    ...
    Because of = () => updater.UpdateAggregateVersions(
        ...
        create_commit(
            0,
            (aggregate_root_1, event_source_1, expected_version_1, 1),
            (aggregate_root_2, event_source_2, expected_version_2, 1)),
        cancellation_token).GetAwaiter().GetResult();

    It should_update_first_aggregate_version = () => verify_updated_aggregate_root_version_for(Times.Once(), (event_source_1, aggregate_root_1), (expected_version_1, expected_version_1 + 1));
    It should_update_second_aggregate_version = () => verify_updated_aggregate_root_version_for(Times.Once(), (event_source_2, aggregate_root_2), (expected_version_2, expected_version_2 + 1));

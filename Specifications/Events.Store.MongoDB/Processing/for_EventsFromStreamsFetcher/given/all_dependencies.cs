...
namespace Dolittle.Runtime.Events.Store.MongoDB.Processing.for_EventsFromStreamsFetcher.given
{
    public class all_dependencies
    {
        ...
        Establish context = () =>
        {
            ...
            events_from_event_log_fetcher.Setup(_ => _.Fetch(Moq.It.IsAny<StreamId>(), Moq.It.IsAny<StreamPosition>(), Moq.It.IsAny<CancellationToken>())).Returns(Task.FromResult<Streams.StreamEvent>(null));
            public_events_fetcher.Setup(_ => _.Fetch(Moq.It.IsAny<StreamId>(), Moq.It.IsAny<StreamPosition>(), Moq.It.IsAny<CancellationToken>())).Returns(Task.FromResult<Streams.StreamEvent>(null));

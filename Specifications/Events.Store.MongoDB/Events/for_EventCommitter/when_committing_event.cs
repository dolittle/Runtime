...
namespace Dolittle.Runtime.Events.Store.MongoDB.Events.for_EventCommitter
{
    public class when_committing_event : given.all_dependencies
    {
        ...
        Because of = () =>
        {
            ...
            result = event_committer.CommitEvent(session, event_log_sequence_number, occurred, execution_context, uncommitted_event, CancellationToken.None).GetAwaiter().GetResult();

...
public class partitioned_stream_event : given.an_event_content_converter
{
    ...
    It should_return_a_committed_external_event = () => result.Event.Should().BeOfType<CommittedExternalEvent>();
    ...
    It should_come_from_the_correct_partition = () => result.Partition.Should().Be(partition);

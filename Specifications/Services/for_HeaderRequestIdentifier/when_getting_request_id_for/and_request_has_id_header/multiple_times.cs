...
public class multiple_times : given.an_identifier_and_a_call_context
{
    ...
    It should_return_the_value_of_the_header_the_first_time = () => first_result.Value.Should().Be("LcDX3TNcXUObGuBe10fG");
    It should_return_the_value_of_the_header_the_second_time = () => second_result.Value.Should().Be("LcDX3TNcXUObGuBe10fG");
    It should_return_the_value_of_the_header_the_third_time = () => third_result.Value.Should().Be("LcDX3TNcXUObGuBe10fG");
}
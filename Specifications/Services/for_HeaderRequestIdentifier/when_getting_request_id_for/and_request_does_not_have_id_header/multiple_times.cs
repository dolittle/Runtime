...
public class multiple_times : given.an_identifier_and_a_call_context
{
    ...
    It should_return_a_non_empty_request_id_the_first_time = () => first_result.Value.Length.Should().BeGreaterThan(0);
    It should_return_a_non_empty_request_id_the_second_time = () => second_result.Value.Length.Should().BeGreaterThan(0);
    It should_return_a_non_empty_request_id_the_third_time = () => third_result.Value.Length.Should().BeGreaterThan(0);

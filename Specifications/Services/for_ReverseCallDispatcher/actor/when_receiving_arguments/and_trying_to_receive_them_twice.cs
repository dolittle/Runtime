...
namespace Dolittle.Runtime.Services.for_ReverseCallDispatcher.actor.when_receiving_arguments;
...
public class and_trying_to_receive_them_twice : given.a_dispatcher
{
    ...
    Because of = () =>
    {
        ...
        exception = Catch.Exception((Action) (() => dispatcher.ReceiveArguments(CancellationToken.None).GetAwaiter().GetResult()));
    };

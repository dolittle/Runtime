...
namespace Dolittle.Runtime.Services.ReverseCalls.for_PingingReverseCallStreamWriterActor.given;
...
public class a_wrapped_stream_writer : all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        writer = factory.CreatePingedWriter(request_id, original_writer.Object, message_converter.Object, cancellation_token);
    };

...
{
    public class when_asking_if_timeseries_can_be_identified_with_a_multiple_systems_able_to
    {
        ...
        Because of = () => result = Catch.Exception(() => mapper.CanIdentify(source, tag));

...
public static class UncommittedAggregateEventsExtension
{
    ...
    public static CommitAggregateEventsRequest ToCommitRequest(this UncommittedAggregateEvents events, ExecutionContext executionContext)
    {
        var request = new CommitAggregateEventsRequest
        {
            ...
            Events = new Dolittle.Runtime.Events.Contracts.UncommittedAggregateEvents
            {
        ...
        request.Events.Events.AddRange(events.Select(_ => new Dolittle.Runtime.Events.Contracts.UncommittedAggregateEvents.Types.UncommittedAggregateEvent
        {
            Content = _.Content,
            Public = _.Public,

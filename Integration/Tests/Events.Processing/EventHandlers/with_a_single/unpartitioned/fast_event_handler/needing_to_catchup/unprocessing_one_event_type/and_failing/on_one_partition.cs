...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unpartitioned.fast_event_handler.needing_to_catchup.unprocessing_one_event_type.and_failing;
...
class on_one_partition : given.single_tenant_and_event_handlers
{
    ...
    Establish context = () =>
    {
        ...
        with_event_handlers((false, 1, ScopeId.Default, true, false));

...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.scoped.unpartitioned.fast_event_handler.with_implicit_filter.needing_to_catchup.unprocessing_one_event_type;
...
class without_problems : given.single_tenant_and_event_handlers
{
    ...
    Establish context = () =>
    {
        ...
        {
            (4, "some_source", "bcb87bbf-f495-4f72-9795-d5e8864add5f")

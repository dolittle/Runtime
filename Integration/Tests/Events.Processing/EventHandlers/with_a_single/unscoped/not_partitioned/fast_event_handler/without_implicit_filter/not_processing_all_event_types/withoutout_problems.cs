...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.not_partitioned.fast_event_handler.without_implicit_filter.not_processing_all_event_types;
...
class without_problems : given.single_tenant_and_event_handlers
{
    ...
    Because of = () => commit_events_after_starting_event_handler((2, "some_source"));

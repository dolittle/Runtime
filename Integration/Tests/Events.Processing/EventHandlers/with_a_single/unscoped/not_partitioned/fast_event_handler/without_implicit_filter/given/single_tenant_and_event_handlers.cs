...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.not_partitioned.fast_event_handler.without_implicit_filter.given;
...
class single_tenant_and_event_handlers : fast_event_handler.given.single_tenant_and_event_handlers
{
    protected static void expect_stream_processor_state_without_failure(IEventHandler event_handler, int num_events_to_handle)
        => expect_stream_processor_state(event_handler, false, true, num_events_to_handle, null!);
    ...
    protected static void expect_stream_processor_state_with_failure(IEventHandler event_handler, failing_unpartitioned_state failing_unpartitioned_state)
        => expect_stream_processor_state(event_handler, false, true, (int)failing_unpartitioned_state.failing_position.Value, failing_unpartitioned_state);

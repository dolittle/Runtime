...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.unpartitioned.fast_event_handler.needing_to_catchup.unprocessing_one_event_type.and_failing;
...
class on_one_partition : given.single_tenant_and_event_handlers
{
    ...
    Establish context = () =>
    {
        ...
        with_event_handlers_filtering_number_of_event_types((false, 1, ScopeId.Default, true, false));

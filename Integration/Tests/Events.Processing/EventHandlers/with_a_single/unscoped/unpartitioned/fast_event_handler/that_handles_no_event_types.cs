...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.unpartitioned.fast_event_handler;
...
class that_handles_no_event_types : given.single_tenant_and_event_handlers
{
    ...
    Establish context = () =>
    {
        ...
        with_event_handlers_filtering_number_of_event_types((false, 0, ScopeId.Default, true, false));

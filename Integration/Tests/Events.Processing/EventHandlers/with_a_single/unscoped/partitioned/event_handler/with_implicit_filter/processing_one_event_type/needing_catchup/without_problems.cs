...
using Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.partitioned.event_handler.with_implicit_filter.given;
using Machine.Specifications;

namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.unscoped.partitioned.event_handler.with_implicit_filter.processing_one_event_type.needing_catchup;
...
class without_problems : given.single_tenant_and_event_handlers
{
    ...
    It should_have_persisted_correct_stream = () => expect_correct_stream_definition(event_handler);

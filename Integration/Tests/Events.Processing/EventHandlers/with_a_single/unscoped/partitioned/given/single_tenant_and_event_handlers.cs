...
class single_tenant_and_event_handlers : unscoped.given.single_tenant_and_event_handlers
{
    protected static void expect_stream_definition(IEventHandler event_handler, int max_handled_event_types)
        => expect_stream_definition(event_handler, partitioned: true, public_stream: false, max_handled_event_types: max_handled_event_types);
    
    protected static void expect_stream_processor_state(IEventHandler event_handler, bool implicit_filter, int num_events_to_handle, failing_partitioned_state failing_partitioned_state)

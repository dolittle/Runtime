...
using single_tenant_and_event_handlers = Integration.Tests.Events.Processing.EventHandlers.with_a_single.partitioned.event_handler.with_implicit_filter.given.single_tenant_and_event_handlers;

namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.partitioned.event_handler.with_implicit_filter.processing_one_event_type.needing_catchup.and_failing;

[Ignore("Implicit filter does not work yet with event handlers")]
class on_both_partitions : single_tenant_and_event_handlers
{

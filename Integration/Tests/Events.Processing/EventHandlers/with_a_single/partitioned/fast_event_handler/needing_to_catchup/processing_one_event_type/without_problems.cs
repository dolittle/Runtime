...
namespace Integration.Tests.Events.Processing.EventHandlers.with_a_single.partitioned.fast_event_handler.needing_to_catchup.processing_one_event_type;
...
class without_problems : given.single_tenant_and_event_handlers
{
    ...
    Establish context = () =>
    {
        ...
        complete_after_processing_number_of_events(4 + 2);

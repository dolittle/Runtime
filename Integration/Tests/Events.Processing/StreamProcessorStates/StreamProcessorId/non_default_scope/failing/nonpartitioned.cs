...
class nonpartitioned : given.a_clean_event_store
{
    ...
    static readonly DateTimeOffset retry_time = DateTimeOffset.Now;
    static readonly DateTimeOffset last_successfully_processed = DateTimeOffset.Now - TimeSpan.FromSeconds(10);
    ...
    static readonly StreamProcessorState stream_processor_state =
        new(new StreamPosition(10), "Testing", retry_time, 1, last_successfully_processed, true);
